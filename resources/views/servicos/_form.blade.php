                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input value="{{ old('posicao', $servico->posicao ?? '')}}" type "input" required class="form-control" name="posicao" id="posicao" data-mask="00" placeholder="Posição do serviço na plataforma">
                            </div>
                        </div>
                    </div>
                </fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input value="{{ old('valor_minimo ', $servico->valor_minimo ?? '')}}" type "input" required class="form-control" name="valor_minimo" id="valor_minimo" data-mask="#.##0,00" data-mask-reverse="true" placeholder="Valor mínimo do serviço">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ old('valor_cocinha', $servico->valor_cocinha ?? '')}}" type "input" required class="form-control" name="valor_cocinha" id="valor_cozinha" data-mask="#.##0,00" data-mask-reverse="true" placeholder="Valor por cozinha">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="horas_cozinha">Quantidade de horas por cozinha</label>
                                <input value="{{ old('horas_cocinha ', $servico->horas_cocinha ?? '')}}" type "input" required class="form-control" name="horas_cocinha" id="horas_cozinha" data-mask="0" placeholder="Quantidade horas por cozinha">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ old('horas_quital', $servico->horas_quital ?? '')}}" type "input" required class="form-control" name="horas_quintal" id="horas_quintal" data-mask="0" placeholder="Quantidade horas por quintal">
                            </div>
                        </div>
                    </div>
